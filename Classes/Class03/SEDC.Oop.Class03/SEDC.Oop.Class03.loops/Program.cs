...
namespace SEDC.Oop.Class03.loops
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int timesToiterate = 100;
            //for(int index = timesToiterate; index>0; index--)
            //{
            ...
            //do
            //{
            //    Console.WriteLine("I will always be executed minimum once");
            //} while (counter != 0);
            //    Console.ReadLine();
            ...
            while (true)
            {
                ...
                Console.WriteLine("Enter a vakid number:");
